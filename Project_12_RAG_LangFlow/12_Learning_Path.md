...
|---|---|---|
| 1 | [LangFlow Quick-Start](./01_LangFlow_QuickStart/) | Setting up LangFlow, understanding components |
| 2 | [Naive RAG Flow](./02_Naive_RAG_Flow/) | The foundational RAG pipeline |
| 3 | [RAG Basics: Introduction](../Project_11_RAG_Basics/01_Introduction_to_RAG.md) | Core theory behind RAG |
...
- **RAG Basics (Theory):** [Project 11](../Project_11_RAG_Basics/)
